    ...
    XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
            ...
            await delay(1000 * 2) 
             ...
             await XeonBotInc.sendMessage(XeonBotInc.user.id, { text: `*ᴅᴇɴᴇᴛʜ-ᴍᴅ ᴠ1*\n

---ᴅᴇɴᴇᴛʜ_xᴅ ᴏꜰꜰɪᴄɪᴀʟ---  

---Thanks for using DENETH-MD-PairCode
       
---©2023-2024 WHITE_DENETH_XD.inc
\n\n ` }, {quoted: xeonses});
              await delay(1000 * 2) 
              process.exit(0)
        }
